...
| [analyze_profile.md](analyze_profile.md) | `analyze_pro.py profile` | `os_toolkit.analysis.profile` |
...
- **Profile (intra):** one root, artifacts under `runs/` — `analyze_profile.md`.
- **Compare (inter):** two feature CSVs — `analyze_compare.md`.
